...
void i2c_Config(void)
{
    ...
    I2CMasterInitExpClk(I2C1_BASE, SysCtlClockGet(), true); // Enable and set frequency to 400 kHz (true) or 100 kHz (false)
	...
	ROM_I2CMasterInitExpClk(I2C0_BASE, ROM_SysCtlClockGet(), 1); // 1 : 400Khz, 0 : 100Khz
	SysCtlDelay(2); // Insert a few cycles after enabling the I2C to allow the clock to be fully activated
